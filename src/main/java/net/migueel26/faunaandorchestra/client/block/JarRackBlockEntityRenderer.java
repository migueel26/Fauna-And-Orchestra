...
public class JarRackBlockEntityRenderer implements BlockEntityRenderer<JarRackBlockEntity> {
    public JarRackBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void render(JarRackBlockEntity blockEntity, float v, PoseStack poseStack, MultiBufferSource bufferSource, int i, int i1) {
