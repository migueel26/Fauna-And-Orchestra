...
public class KoalaRenderer extends GeoEntityRenderer<WanderingKoalaEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, WanderingKoalaEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
