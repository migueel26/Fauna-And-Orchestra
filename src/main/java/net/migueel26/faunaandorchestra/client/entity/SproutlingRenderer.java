...
public class SproutlingRenderer extends GeoEntityRenderer<SproutlingEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, SproutlingEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
