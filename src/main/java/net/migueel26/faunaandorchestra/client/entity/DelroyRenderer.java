...
public class DelroyRenderer extends GeoEntityRenderer<Delroy> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Delroy animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
