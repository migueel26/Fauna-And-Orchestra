...
public class DanBRenderer extends GeoEntityRenderer<DanB> {
    ...
    @Override
    public void preRender(PoseStack poseStack, DanB animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
