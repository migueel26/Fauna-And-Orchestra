...
public class ButlerKoalaRenderer extends GeoEntityRenderer<ButlerKoalaEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, ButlerKoalaEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
