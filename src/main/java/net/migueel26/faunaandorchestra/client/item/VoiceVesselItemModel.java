...
public class VoiceVesselItemModel extends GeoModel<VoiceVesselItem> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(FaunaAndOrchestra.MOD_ID, "textures/item/voice_vessel.png");
    ...
    private static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath(FaunaAndOrchestra.MOD_ID, "geo/item/voice_vessel.geo.json");
    @Override
