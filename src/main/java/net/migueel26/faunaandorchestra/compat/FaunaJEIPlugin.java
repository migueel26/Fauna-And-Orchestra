...
public class FaunaJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addIngredientInfo(ModItems.FLORA_FORTA.get(), symphoniaDefaultText());
        registration.addIngredientInfo(ModItems.REALLY_GOOD_STICK.get(), symphoniaDefaultText());
        registration.addIngredientInfo(ModItems.FORTUNE_COOKIE.get(), symphoniaDefaultText());
        registration.addIngredientInfo(ModItems.BUSINESS_CARD.get(), symphoniaDefaultText());
