...
public class Denzel extends TravellingMusician implements Npc, GeoEntity {
    ...
    private final AnimationController<Denzel> jazzyDammyController = new AnimationController<>(this, "denzel_controller", 5, this::jazzyDammyState);
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    // TALKABLE (NOT REALLY USEFUL FOR NOW)
    protected static final EntityDataAccessor<Integer> CONFIDENCE = SynchedEntityData.defineId(Denzel.class, EntityDataSerializers.INT);
    protected static final EntityDataAccessor<Boolean> GOOD_MORNING = SynchedEntityData.defineId(Denzel.class, EntityDataSerializers.BOOLEAN);
    public static final int COOL_CONFIDENCE = 35;
    public static final ResourceLocation ICON = ResourceLocation.fromNamespaceAndPath(FaunaAndOrchestra.MOD_ID, "textures/gui/entity/denzel_icon.png");
    ...
    public Denzel(EntityType<? extends AgeableMob> entityType, Level level) {
        ...
        this.setCustomName(Component.translatable("entity.faunaandorchestra.denzel"));
    }
