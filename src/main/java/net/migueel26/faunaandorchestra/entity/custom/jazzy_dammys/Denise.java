...
public class Denise extends TravellingMusician implements Npc, GeoEntity {
    // ANIMATION
    private static final RawAnimation PLAYING = RawAnimation.begin().thenPlay("playing");
    private static final RawAnimation WALK = RawAnimation.begin().thenPlay("walk");
    private static final RawAnimation IDLE = RawAnimation.begin().thenPlay("idle");
    private final AnimationController<Denise> jazzyDammyController = new AnimationController<>(this, "denise_controller", 5, this::jazzyDammyState);
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    // TALKABLE (NOT REALLY USEFUL FOR NOW)
    protected static final EntityDataAccessor<Integer> CONFIDENCE = SynchedEntityData.defineId(Denise.class, EntityDataSerializers.INT);
    protected static final EntityDataAccessor<Boolean> GOOD_MORNING = SynchedEntityData.defineId(Denise.class, EntityDataSerializers.BOOLEAN);
    public static final int COOL_CONFIDENCE = 35;
    public static final ResourceLocation ICON = ResourceLocation.fromNamespaceAndPath(FaunaAndOrchestra.MOD_ID, "textures/gui/entity/denise_icon.png");
    protected int confidence;
    public static final String RESOURCE = "dialogue.faunaandorchestra.denise";
    public String currentDialogue;

    public Denise(EntityType<? extends AgeableMob> entityType, Level level) {
        super(entityType, level);

        this.setCustomName(Component.translatable("entity.faunaandorchestra.denise"));
    }
