...
public class LetterAndQuillMenu extends AbstractContainerMenu {
    ...
    public static LetterAndQuillMenu create(int containerId, Inventory inv, FriendlyByteBuf buf) {
        return new LetterAndQuillMenu(containerId, inv, ContainerLevelAccess.NULL);
    }

    public LetterAndQuillMenu(int containerId, Inventory inv, ContainerLevelAccess access) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, ModBlocks.LETTER_AND_QUILL.get());
    }
